...
%on ezgcd; 
%\end{reduce}
Let's make the algebra case sensitive: for \emph{psl} we set \verb|raise|; whereas for \emph{csl} we set \verb|lower|.  
...
\begin{reduce}
write "Construct invariant manifold (version 26 Feb 2026)"$
