...
\begin{reduce}
% from reduce.rlfi, version 23/05/1995
% AJR, modified 17/3/2026
...
without \verb|gcd|.  Unfortunately, \verb|ezgcd| also crashes \verb|psl| so leave it off for now (4 Nov 2025).
%\begin{reduce}
%on ezgcd; 
%\end{reduce}
...
\begin{reduce}
write "Construct invariant manifold (version 18 Mar 2026)"$
