...
%on ezgcd; 
%\end{reduce}
If using \emph{psl}-Reduce, then let's make the algebra case sensitive (as of 2025, \emph{csl} does not seem to permit case sensitive).   Remember (currently, 2025) \verb|off latex| automatically turns \verb|raise| on.
\begin{reduce}
off raise;
\end{reduce}
...
\begin{reduce}
write "Construct invariant manifold (version 5 Nov 2025)"$
