...
procedure: the \verb|rlfi| package, with override of some 
name translations; and operator names for the variables 
...
%Similarly, try loading LaTeX names of symbols here so that
%a user can override.  Works to some extent, but do not know
%how to change u() and s().
%\begin{reduce}
%defid u1,name="u_1"; 
%defid u2,name="u_2"; 
%defid u3,name="u_3"; 
...
pp, est, eyem, m, pdfzero;
\end{reduce}

Write an intro message.
\begin{reduce}
write "Construct invariant manifold (version 12 Mar 2026)"$
...
\begin{reduce}
defindex diff(down);
defid diff,name="\diff"; %AJR, 2026-01-16: delete?  
