...
\(u_{1}=3/8 \eps^{3} s_{1}^{4}-1/2 \eps s_{1}^{2}+O\big(\varepsilon ^{4}
\big)+s_{1}
\)\par

\(u_{2}=-3/8 \eps^{3} s_{1}^{4}+1/2 \eps s_{1}^{2}+O\big(\varepsilon ^{4}
\big)+s_{1}
\)\par
...
\(\dot s_{1}=-3/4 \eps^{4} s_{1}^{5}+\eps^{2} s_{1}^{3}+O\big(\varepsilon 
^{5}\big)
\)\par
...
^{2}-1/2 \eps s_{1}+O\big(\varepsilon ^{5}\big)+1/2
\)\par
