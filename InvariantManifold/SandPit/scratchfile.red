...
tmp_(5):=coeffn(small*uu,e_(5,1),1)/small +order_(varepsilon^3);

tmp_(6):=coeffn(small*uu,e_(6,1),1)/small +order_(varepsilon^3);

tmp_(7):=coeffn(small*uu,e_(7,1),1)/small +order_(varepsilon^3);
...
tmp_s(4):=1*coeffn(gg,e_(4,1),1)+order_(varepsilon^4);

tmp_s(5):=1*coeffn(gg,e_(5,1),1)+order_(varepsilon^4);
