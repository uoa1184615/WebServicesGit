...
(B2)---except of course for the quadratic noise-noise
induced drifts in his It\^o~form.

The stochastic parts of \cite{Falasca2025}'s (B2) now come
from the projection of forcing onto the above deterministic
slow manifold.
