...
% appendix B.2.  AJR, 8 Jul 2025 -- 25 Mar 2026
...
\varepsilon := {\epsilon}\) for convenience. In terms
of new dependent variables \(u_j:=x_j\) the above triad
system becomes
\begin{align*}&
	\frac{du_1}{dt} = \varepsilon( L_1u_1+L_2u_2+L_3u_3+Iu_2u_3 ),
	\\&
	\frac{du_2}{dt} = -\gamma_2u_2 +\varepsilon( -L_2u_1-Iu_1^2 )
	+\sigma_2\dot W_2\,,
	\\&
	\frac{du_3}{dt} = -\gamma_3u_3 -\varepsilon L_3u_1
	+\sigma_3\dot W_3\,,
\end{align*}
...
stochastic noise): these explicit \verb|small| factors
encode~\(\epsilon\) factors;
\begin{reduce}
factor small;
invariantmanifold({},
...
\begin{align*}&
\dot u_{1}=\eps \big(L_{3} u\_3+L_{2} u\_2+L_{1} u\_1+I u\_1 u\_2\big)
\\&
\dot u_{2}=\eps \big(-L_{2} u\_1-I u\_1^{2}\big)-\gamma _{2} u\_2
\\&
\dot u_{3}=-\eps L_{3} u\_1-\gamma _{3} u\_3
\end{align*}
Here, \(\eps\)\ counts the order of perturbation
in~\(\epsilon\).
...
\begin{align*}&
u_{1}=s_{1}+O\big(\varepsilon ^{3}\big)
\\&
u_{2}=\ParMath{ \eps \big(-L_{2} \gamma _{2}^{-1} s_{1}
-\gamma _{2}^{-1} s_{1}^{2} I\big) +\eps^{2} \big(L_{2}
L_{1} \gamma _{2}^{-2} s_{1} +2 L_{1} \gamma _{2}^{-2}
s_{1}^{2} I\big) +O\big(\varepsilon ^{3}\big)
}\\&
u_{3}=\ParMath{ -\eps L_{3} \gamma _{3}^{-1} s_{1}
+\eps^{2} L_{3} L_{1} \gamma _{3}^{-2} s_{1}
+O\big(\varepsilon ^{3}\big)
}
\end{align*}
...
\vec z :=
\begin{bmatrix} 
1 +\eps^{2} \big(L_{3}^{2} \gamma _{3}^{-2} +L_{2}^{2}
\gamma _{2}^{-2} +3 L_{2} \gamma _{2}^{-2} s_{1} I +2 \gamma
_{2}^{-2} s_{1}^{2} I^{2}\big) +O\big(\varepsilon ^{3}\big)
\\[1ex]
+\eps \big(L_{2} \gamma _{2}^{-1}+\gamma _{2}^{-1} s_{1}
I\big) -\eps^{2} L_{2} L_{1} \gamma _{2}^{-2}
+O\big(\varepsilon ^{6} \big)
\\[1ex]
+\eps L_{3} \gamma _{3}^{-1} -\eps^{2} L_{3} L_{1}
\gamma _{3}^{-2} +O\big(\varepsilon ^{3}\big)
\end{bmatrix}
\\&\quad{}=
\begin{bmatrix} 
...
\\[1ex]
+\eps \big(L_{2} \gamma _{2}^{-1}+\gamma _{2}^{-1} s_{1}
I\big) +O\big(\varepsilon ^{2} \big)
\\[1ex]
+\eps L_{3} \gamma _{3}^{-1} +O\big(\varepsilon
^{2}\big)
\end{bmatrix}.
\end{align*}
...
\begin{equation*}
+\eps \big(L_{2} \gamma _{2}^{-1}+\gamma _{2}^{-1} s_{1}
I\big)\sigma_2\dot W_2 +\eps L_{3} \gamma
