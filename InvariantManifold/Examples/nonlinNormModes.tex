...
factor small;
\end{reduce}
The following code makes the linear damping to be effectively 
small; consequently, also scale the smallness of the cubic 
nonlinearity to match.
\begin{reduce}
invariantmanifold({},
    mat(( u3,
          u4,
...
\dot u_{1}=u\sb3\,,
&&
\dot u_{3}=\eps \big(-1/2 u\sb1^{3}-3/10 u\sb3+3/10 u\sb4\big)-2 
u\sb1+u\sb2\,,
\\&
\dot u_{2}=u\sb4\,,
&&
\dot u_{4}=\eps \big(3/10 u\sb3-3/5 u\sb4\big)+u\sb1-2 u\sb2\,.
\end{align*}
...
\begin{align*}&
\dot s_{1}=3/4 s_{4} s_{3} s_{1} \eps i+3/8 s_{2} s_{1}^{2} \eps
 i-3/40 s_{1} \eps
\\&
\dot s_{2}=-3/4 s_{4} s_{3} s_{2} \eps i-3/8 s_{2}^{2} s_{1} \eps^{2
} i-3/40 s_{2} \eps
\\&
\dot s_{3}=1/8 \sqrt {3} s_{4} s_{3}^{2} \eps i+1/4 \sqrt {3} s_{3} 
s_{2} s_{1} \eps i-3/8 s_{3} \eps
\\&
\dot s_{4}=-1/8 \sqrt {3} s_{4}^{2} s_{3} \eps i-1/4 \sqrt {3} s_{4}
 s_{2} s_{1} \eps i-3/8 s_{4} \eps
\end{align*}
