...
\(
\)\par
\(u_{1}=1/16 \frac{\partial ^{3}s_{1}}{\partial x^{3}} \eps^{3}-1/4 \frac{
\partial \,s_{1}}{\partial \,x} \eps+O\big(\varepsilon ^{4}\big)+1/2 s_{
1}
\)\par
\(u_{2}=-1/16 \frac{\partial ^{3}s_{1}}{\partial x^{3}} \eps^{3}+1/4 
\frac{\partial \,s_{1}}{\partial \,x} \eps+O\big(\varepsilon ^{4}\big)+1
/2 s_{1}
\)\par
\(
\)
...
\(
\)\par
\(\dot s_{1}=-1/8 \frac{\partial ^{4}s_{1}}{\partial x^{4}} \eps^{4}+1/2 
\frac{\partial ^{2}s_{1}}{\partial x^{2}} \eps^{2}+O\big(\varepsilon ^{5
}\big)
\)\par
\(
\)
