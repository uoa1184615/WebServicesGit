...
effectively small; and also explicitly scales the 
smallness of the nonlinearities.
\begin{reduce}
invariantmanifold({},
    mat(( u3, u4,
...
\dot u_{2}=u\_4\,,
\\&
\dot u_{3}=F\_1 \eps +\eps \big(-1/2 u\_1^{3}-3/
10 u\_3+3/10 u\_4\big)-2 u\_1+u\_2\,,
\\&
\dot u_{4}=F\_2 \eps \big(3/10 u\_3-3/5 u\_4\big)+u\_1-2 u\_2\,.
\end{align*}
...
\begin{align*}&
u_{1}=\ParMath{
-5/9 \frac{\partial ^{2}F\_1}{\partial t^{2}} \eps{}+\frac{
\partial ^{2}F\_2}{\partial t^{2}} \eps{} \big(33/320 \exp \big(-i t
\big) s_{2} i-33/320 \exp \big(i t\big) s_{1} i\big)+\frac{\partial \,
F\_2}{\partial \,t} \eps{} \big(3/32 \exp \big(-i t\big) s_{2}+3/32 
\exp \big(i t\big) s_{1}\big)+2/3 F\_1 \eps{}+F\_2 \eps{} \big(-3/80
 \exp \big(-i t\big) s_{2} i+3/80 \exp \big(i t\big) s_{1} i\big)+\eps{
} \big(-9/16 \exp \big(-i t\big) s_{2}^{2} s_{1}+7/96 \exp \big(-3 i t
\big) s_{2}^{3}-9/16 \exp \big(i t\big) s_{2} s_{1}^{2}+7/96 \exp \big(3
 i t\big) s_{1}^{3}\big)+\exp \big(-i t\big) s_{2}+\exp \big(i t\big) s_
{1}+O\big(\varepsilon ^{2}\big)
}\\&
u_{2}=\ParMath{
-4/9 \frac{\partial ^{2}F\_1}{\partial t^{2}} \eps{}+\frac{
\partial ^{2}F\_2}{\partial t^{2}} \eps{} \big(-39/320 \exp \big(-i t
\big) s_{2} i+39/320 \exp \big(i t\big) s_{1} i\big)+\frac{\partial \,
F\_2}{\partial \,t} \eps{} \big(-9/160 \exp \big(-i t\big) s_{2}-9/160
 \exp \big(i t\big) s_{1}\big)+1/3 F\_1 \eps{}+F\_2 \eps{} \big(9/80
 \exp \big(-i t\big) s_{2} i-9/80 \exp \big(i t\big) s_{1} i\big)+\eps{}
  \big(3/16 \exp \big(-i t\big) s_{2}^{2} s_{1}-1/96 \exp \big(-3 i t
\big) s_{2}^{3}+3/16 \exp \big(i t\big) s_{2} s_{1}^{2}-1/96 \exp \big(3
 i t\big) s_{1}^{3}\big)+\exp \big(-i t\big) s_{2}+\exp \big(i t\big) s_
{1}+O\big(\varepsilon ^{2}\big)
}\\&
u_{3}=\ParMath{
2/3 \frac{\partial \,F\_1}{\partial \,t} \eps{}+\frac{\partial 
^{2}F\_2}{\partial t^{2}} \eps{} \big(63/320 \exp \big(-i t\big) s_{2}
+63/320 \exp \big(i t\big) s_{1}\big)+\frac{\partial \,F\_2}{\partial \,
t} \eps{} \big(-21/160 \exp \big(-i t\big) s_{2} i+21/160 \exp \big(i 
t\big) s_{1} i\big)+F\_2 \eps{} \big(-9/80 \exp \big(-i t\big) s_{2}-9
/80 \exp \big(i t\big) s_{1}\big)+\eps{} \big(3/16 \exp \big(-i t\big)
...
u_{4}=\ParMath{
1/3 \frac{\partial \,F\_1}{\partial \,t} \eps{}+\frac{\partial 
^{2}F\_2}{\partial t^{2}} \eps{} \big(-57/320 \exp \big(-i t\big) s_{2
}-57/320 \exp \big(i t\big) s_{1}\big)+\frac{\partial \,F\_2}{\partial 
\,t} \eps{} \big(27/160 \exp \big(-i t\big) s_{2} i-27/160 \exp \big(i
 t\big) s_{1} i\big)+F\_2 \eps{} \big(3/80 \exp \big(-i t\big) s_{2}+3
/80 \exp \big(i t\big) s_{1}\big)+\eps{} \big(-9/16 \exp \big(-i t
...
^{2} s_{1} i+\frac{\partial ^{2}F\_2}{\partial t^{2}} \eps^2 \big(99/
2560 s_{2} s_{1}^{2}+9/320 s_{1} i\big)+9/256 \frac{\partial \,F\_2}{
\partial \,t} F\_2 \eps^2 s_{1}+\frac{\partial \,F\_2}{\partial \,t} 
\eps^2 \big(27/256 s_{2} s_{1}^{2} i-9/400 s_{1}\big)+9/640 F\_2^{2} 
\eps^2 s_{1} i+F\_2 \eps^2 \big(-9/80 s_{2} s_{1}^{2}-9/800 s_{1} i
\big)-3/40 F\_2 \eps{} s_{1}+\eps^2 \big(-155/256 s_{2}^{2} s_{1}^{3
} i+9/160 s_{2} s_{1}^{2}\big)+3/8 \eps{} s_{2} s_{1}^{2} i+O\big(
\varepsilon ^{3}\big)
}\\&
\dot s_{2}=\ParMath{
531/12800 \frac{\partial ^{2}F\_2}{\partial t^{2}} F\_2 \eps
^{2} s_{2} i+\frac{\partial ^{2}F\_2}{\partial t^{2}} \eps^2 \big(99/
2560 s_{2}^{2} s_{1}-9/320 s_{2} i\big)+9/256 \frac{\partial \,F\_2}{
\partial \,t} F\_2 \eps^2 s_{2}+\frac{\partial \,F\_2}{\partial \,t} 
\eps^2 \big(-27/256 s_{2}^{2} s_{1} i-9/400 s_{2}\big)-9/640 F\_2^{2} 
\eps^2 s_{2} i+F\_2 \eps^2 \big(-9/80 s_{2}^{2} s_{1}+9/800 s_{2} i
\big)-3/40 F\_2 \eps{} s_{2}+\eps^2 \big(155/256 s_{2}^{3} s_{1}^{2}
 i+9/160 s_{2}^{2} s_{1}\big)-3/8 \eps{} s_{2}^{2} s_{1} i+O\big(
\varepsilon ^{3}\big)
}
\end{align*}
