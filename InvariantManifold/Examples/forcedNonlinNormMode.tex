...
I set \Reduce\ to be case sensitive so we can use upper-case forcing, for example.
\begin{reduce}
factor F_1,F_2,small;
\end{reduce}
The following code makes the linear damping to be
effectively small; consequently, also scale the smallness of the
...
\dot u_{2}=u\sb4\,,
\\&
\dot u_{3}=F_1 \eps \big(\tfrac{1}{2} \exp \big(-i t\big) i-\tfrac{1}{2} \exp \big(i 
t\big) i\big)+\eps \big(-\tfrac{1}{2} u\sb1^{3}-\tfrac{3}{10} u\sb3+\tfrac{3}{10} u\sb4\big)
\\&\qquad{}
-2 u\sb1+u\sb2\,,
\\&
\dot u_{4}=F_2 \eps \big(\tfrac{3}{20} \exp \big(-i t/2\big) u\sb3
...
\begin{align*}&
\dot s_{1}=F_1 \eps^{2} \big(\tfrac{9}{64} s_{2} s_{1}-\tfrac{9}{128} s_{1}^{2}+\tfrac{3}{160} i
\big)-\tfrac{1}{8} F_1 \eps
+\tfrac{93}{5500} F_2^{2} \eps^{2} s_{1} i
\\&\qquad{}
+\eps^{2} \big(
-\tfrac{155}{256} s_{2}^{2} s_{1}^{3} i+\tfrac{9}{160} s_{2} s_{1}^{2}\big)
+\tfrac{3}{8} \eps s
_{2} s_{1}^{2} i+O\big(\varepsilon ^{3}\big)
\\&
\dot s_{2}=F_1 \eps^{2} \big(-\tfrac{9}{128} s_{2}^{2}+\tfrac{9}{64} s_{2} s_{1}-\tfrac{3}{160} i
\big)-\tfrac{1}{8} F_1 \eps
-\tfrac{93}{5500} F_2^{2} \eps^{2} s_{2} i
\\&\qquad{}
+\eps^{2} \big(
\tfrac{155}{256} s_{2}^{3} s_{1}^{2} i+\tfrac{9}{160} s_{2}^{2} s_{1}\big)
-\tfrac{3}{8} \eps s_
{2}^{2} s_{1} i+O\big(\varepsilon ^{3}\big)
\end{align*}
