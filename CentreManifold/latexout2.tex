...
The output line length of each `write' statement must be short enough as otherwise Reduce puts in a line break---its counting is a bit mysterious!

\begin{reduce}
out "scratchfile.red";
write "write ""\)
\paragraph{The ",natureMan_,"
manifold}";
write "These give the location of the invariant manifold in
...
manifold ODEs}";
write "The system evolves on the invariant manifold such
